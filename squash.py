...
def game(arank, brank):
    ...
    # while True: # noqa: E800
    #     if (max(ascore, bscore) >= 11: # noqa: E800
    #        if max(ascore, bscore) - min(ascore, bscore) >= 2): # noqa: E800
    #           break # noqa: E800
    #     if random.random() < pa: # noqa: E800
    #         ascore += 1 # noqa: E800
    #     else: # noqa: E800
    #         bscore += 1 # noqa: E800
    ...
    # status = True # noqa: E800
    # while status: # noqa: E800
    #     if (max(ascore, bscore) >= 11: # noqa: E800
    #        if max(ascore, bscore) - min(ascore, bscore) >= 2): # noqa: E800
    #           return ascore, bscore # noqa: E800
    #           status = False # noqa: E800
    #     if random.random() < pa: # noqa: E800
    #         ascore += 1 # noqa: E800
    #     else: # noqa: E800
    #         bscore += 1 # noqa: E800
...
def winProbability(arank, brank, simulations=10000):
    ...
    # range(0, simulations) or range(1, simulations+1) # noqa: E800
...
def matchWinProbability(arank, brank, n, simulations=10000, gamefunc=game):
    ...
    for i in range(simulations):
        ...
        # prob = awins / simulations # noqa: E800
...
def readCSV(filename):
    with open(filename) as csvfile:
        ...
        for row in reader:
            ...
            # iteration:
            # if not firstLine: # noqa: E800
            #    data.append((float(row[0]), float(row[1]))) # noqa: E800
    return data
...
def plotWinProbabilities(data):
    ...
    # x = [ra / rb for ra, rb in data] # noqa: E800
    # y = [winProbability(ra, rb) for ra, rb in data] # noqa: E800
    plt.plot(x, y, 'o')
    ...
    # data = sorted(data, key=lambda x: x[0] / x[1]) # noqa: E800
    ...
    # an argument e.g. plotWinProbabilities(data, filename="test.pdf") # noqa: E800
    # and plt.savefig(filename) # noqa: E800
